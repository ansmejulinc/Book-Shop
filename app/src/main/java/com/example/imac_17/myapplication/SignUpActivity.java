...
public class SignUpActivity extends AppCompatActivity {
    ...
    private EditText nameEditText, userEditText, passworEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passworEditText = (EditText) findViewById(R.id.editText3);
    ...
    public void clickSignUpSign(View view) {
        ...
        passwordString = passworEditText.getText().toString().trim();
        //Check Space
